...
ReferenceDescriptor = _reflection.GeneratedProtocolMessageType('ReferenceDescriptor', (_message.Message,), {
  'DESCRIPTOR' : _REFERENCEDESCRIPTOR,
  '__module__' : 'reference_desc_pb2'
